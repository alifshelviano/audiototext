...
//   static async analyzeMeeting(meetingId: string): Promise<{
//     success: boolean;
//     summary?: any;
//     error?: string;
//   }> {
...
//   static async shouldAutoAnalyze(meetingId: string): Promise<boolean> {
//     try {
//       const meeting = await getMeeting({ meetingId });
...
//       if (!meeting.summary && meeting.transcripts.length > 0) {
//         return true;
//       }
