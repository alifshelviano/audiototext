...
export default function Page() {
  ...
  const InviteTeamButton = (
    ...
    >
      ...
      <div className="w-full bg-white text-green-600 py-2 px-4 rounded-lg font-medium text-center">
        Invite Team
      </div>
    </div>
  );

  const LoginToCreateMeetingButton = (
    <div
      className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-6 text-white cursor-pointer hover:from-blue-600 hover:to-blue-700 transition-all duration-200"
      onClick={() => signIn()}
    >
      <div className="flex items-center gap-3 mb-3">
        <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
      ...
      <p className="text-blue-100 text-sm mb-4">
        Log in to create meeting rooms and invite your team.
      </p>
      <div className="w-full bg-white text-blue-600 py-2 px-4 rounded-lg font-medium text-center">
        ...
        <div className="flex">
          ...
          <main className="flex-1 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              {isAuthenticated ? InviteTeamButton : LoginToCreateMeetingButton}
            </div>
