...
import { BarChart, Zap, Heart, CheckCircle, CalendarIcon, TrendingUp, TrendingDown } from 'lucide-react';
import type { MeetingData, MeetingSummary, MeetingHealthScore } from '@/types/meeting';
...
export function InsightsTab({ meeting }: InsightsTabProps) {
  const getStructuredSummary = (): StructuredSummary => {
    if (meeting?.summary?.meeting_summary) {
      return meeting.summary.meeting_summary as StructuredSummary;
    }
