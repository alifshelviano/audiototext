...
export function QRCodeDisplay({ url, size = 140, className = '' }: QRCodeDisplayProps) {
  ...
  return (
    <>
    <div className={`bg-white rounded-xl border border-gray-200 p-6 shadow-lg w-full max-w-[300px] sm:max-w-[420px] mx-auto overflow-hidden ${className}`}>
  <div className="flex flex-col md:flex-row items-center md:items-start gap-6 text-center md:text-left">
    ...
    <div className="flex-1 space-y-4 min-w-0">
      ...
      <div className="space-y-2">
        ...
        >
          <div className="flex-1 min-w-0">
            <p className="text-xs text-gray-700 break-all font-mono leading-tight">
              {url}
            </p>
          </div>
          <button
      ...
      <div className="space-y-2">
        {canShare && (
          <button
            onClick={handleShare}
            className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-cyan-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium"
          >
        ...
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            className="px-2 py-1.5 bg-gray-100 text-gray-700 rounded text-xs hover:bg-gray-200 transition-colors font-medium text-center"
          >
            Email
          </button>
          <button
    ...
    //     <div className="flex flex-col md:flex-row items-center md:items-start gap-6 text-center md:text-left">
    //     {/* <div className="flex flex-col items-center md:items-start flex-shrink-0"> */}
    //       {/* <div className="p-3 bg-white rounded-lg border border-gray-100 mb-2"> */}
    //       <div className="p-3 bg-gray-50 rounded-xl border border-gray-200 mb-2 flex-shrink-0">
    //         <QRCodeCanvas 
    //           value={url} 
    //           size={qrSize}
    //           fgColor="#000000"
    ...
    //         >
    //           <div className="flex-1 min-w-0">
    //             <p className="text-xs text-gray-600 break-words font-medium line-clamp-2">{url}</p>
    //           </div>
    //           <button
