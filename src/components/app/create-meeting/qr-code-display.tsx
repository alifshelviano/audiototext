...
//   return (
//     <div
//       className={`relative bg-white rounded-xl border border-gray-200 p-6 shadow-lg w-full max-w-[320px] sm:max-w-[420px] mx-auto overflow-hidden ${className}`}
//     >
//       {/* Close Button (X) */}
//       {/* {onClose && (
//         <button
...
//           <button
//             onClick={handleShare}
//             className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-cyan-600 text-white rounded-lg hover:bg-cyan-700 transition-colors text-sm font-medium"
//           >
...
//             className="px-2 py-1.5 bg-gray-100 text-gray-700 rounded text-xs hover:bg-gray-200 transition-colors font-medium"
//           >
//             Email
//           </button>
//           <button
...
//           <button
//             onClick={onClose}
//             className="w-full px-3 py-2 border border-gray-300 text-gray-700 rounded-lg text-sm hover:bg-gray-100 transition-colors font-medium"
//           >
//             Cancel
//           </button>
//         )}
...
export function QRCodeDisplay({ url, size = 160, className = "", onClose }: QRCodeDisplayProps) {
  ...
  return (
    <>
      <div
        className={`relative bg-white rounded-2xl shadow-xl border border-gray-200 w-full max-w-[1300px] mx-auto p-6 sm:p-8 text-center ${className}`}
      >
        {onClose && (
          <button
            onClick={onClose}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 justify-items-center mb-4">
          {canShare && (
            <button
              onClick={handleShare}
