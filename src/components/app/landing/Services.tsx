          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className={`${index % 2 === 1 ? "md:order-1 text-left md:text-right" : "md:order-2 text-left"}`}>
                <h3 className="text-2xl font-bold text-cyan-700 mb-4">{service.title}</h3>
                <p className="text-gray-700 mb-6 leading-relaxed">{service.description}</p>
                <a href={service.link} className="inline-flex items-center text-cyan-600 font-semibold hover:text-cyan-800 transition">
                  Learn More
