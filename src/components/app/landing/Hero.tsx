    ...
    >
      <div className="container mx-auto px-6 flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
        ...
        <div className="lg:w-1/2 text-center lg:text-left">
          ...
          >
            LISN AI automatically summarizes your meetings in real-time. Record,
            transcribe, and get instant meeting insights.
          </motion.p>
        ...
        >
          <Image
            src="/assets/ilustrasi3.png"
            alt="Team collaboration"
            width={500}
            height={500}
            quality={100}
            priority
            className="max-w-full w-[480px] drop-shadow-lg"
          />
        </motion.div>
      </div>
          ...
          >
            ...
            >
              ...
              <button
                ...
                className="absolute top-3 right-3 text-white bg-white/20 hover:bg-white/40 rounded-full w-10 h-10 flex items-center justify-center text-xl"
              >
                ✕
              </button>
            </motion.div>
